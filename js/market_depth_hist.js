...
const getChartData2_backend = (ts, currentTimestamp) => {
    dataSet = [];
    $.ajax({
        url: root_1_hist + route + '/MONEYFLOW ABS B',
        type: 'GET',
        dataType: 'json',
        data: {
            cast: 'hist',
...
const getChartData3_backend = (ts, currentTimestamp) => {
    dataSet = [];
    $.ajax({
        url: root_1_hist + route + '/MONEYFLOW REL B',
        type: 'GET',
        dataType: 'json',
        data: {
            cast: 'hist',
...
dataTable = $('#depth_1_highpowstocks').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route + '/MONEYFLOW ABS',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
dataTable_2 = $('#depth_2_intradayboost').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route + '/MONEYFLOW REL',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
dataTable_3 = $('#depth_3_toplevelstocks').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route + '/NEAR DAYS HIGH',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
dataTable_4 = $('#depth_4_lowlevelstocks').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route + '/NEAR DAYS LOW',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
