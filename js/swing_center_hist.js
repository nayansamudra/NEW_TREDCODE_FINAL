...
const getpieDount = (ts, currentTimestamp) => {
    dataSet = [];
    $.ajax({
        url: root_1_hist + route_1 + '/Nifty 50 ADVANCE DECLINE',
        method: 'GET',
        dataType: 'json',
        data: {
            cast: 'hist',
...
const getpieDount1 = (ts, currentTimestamp) => {
    ...
    $.ajax({
        url: root_1_hist + route_1 + '/FO ADVANCE DECLINE',
        method: 'GET',
        dataType: 'json',
        data: {
            cast: 'hist',
...
tendayhighbo = $('#tendayhighbo').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route_3 + '/10 DAY HIGH BO?count=5',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
tendaylowbo = $('#tendaylowbo').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route_3 + '/10 DAY LOW BO?count=5',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
fiftydayhighbo = $('#fiftydayhighbo').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route_3 + '/50 DAY HIGH BO?count=5',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
fiftydaylowbo = $('#fiftydaylowbo').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route_3 + '/50 DAY LOW BO?count=5',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
function getChartData(ts, currentTimestamp) {
    $.ajax({
        url: root_1_hist + route_1 + '/MAJOR INDEX WEEKLY PERFORMANCE',
        method: 'GET',
        dataType: 'json',
        data: {
            cast: 'hist',
