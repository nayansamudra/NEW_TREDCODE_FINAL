...
root_1_hist = "https://ebs.tradingcafeindia.com"; // (Live Price)
route_dhan = "/dhan";
...
const getChartData_ps1 = (ts, currentTimestamp) => {
    ...
    $.ajax({
        url: root_1_hist + route_1 + '/5 minute MOMENTUM SPIKE',
        type: 'GET',
        dataType: 'json',
        data: {
            cast: 'hist',
...
const getChartData_ps2 = (ts, currentTimestamp) => {
    ...
    $.ajax({
        url: root_1_hist + route_1 + '/10 minute MOMENTUM SPIKE',
        type: 'GET',
        dataType: 'json',
        data: {
            cast: 'hist',
...
dataTable = $('#prosetup_1_downsidelomintra').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route_2 + '/TCI BULL DIV 15 MIN?count=5',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
dataTable_2 = $('#prosetup_2_upsidelomintra').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route_2 + '/TCI BEAR DIV 15 MIN?count=5',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
dataTable_3 = $('#prosetup_3_downsidelomswing').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route_2 + '/TCI BULL DIV 1 HR?count=5',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
dataTable_4 = $('#prosetup_4_upsidelomswing').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route_2 + '/TCI BEAR DIV 1 HR?count=5',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
dataTable_5 = $('#prosetup_5_multiresistancebo').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route_2 + '/2 DAY HIGH BREAK LIVE?count=5',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
dataTable_6 = $('#prosetup_6_multisupportbo').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route_2 + '/2 DAY LOW BREAK LIVE?count=5',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
dataTable_7 = $('#prosetup_7_multiresistancebo_eod').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route_2 + '/TCI 2 day high EOD?count=5',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
dataTable_8 = $('#prosetup_8_multisupportbo_eod').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route_2 + '/TCI 2 day low EOD?count=5',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
dataTable_9 = $('#prosetup_9_dailycontraction').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route_2 + '/TCI NR7 INSIDER EOD?count=5',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
pm = $('#prosetup_10_premarket').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route_3 + '/latest/NIFTY',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
const pre_mkt_change = (type) => {
    const url = type === "Nifty" ? root_1_hist + route_3 + '/latest/NIFTY' : root_1_hist + route_3 + '/latest/FO';
    $.ajax({
        type: 'GET',
        url: url,
