...
const getChartData_sec1 = (ts, currentTimestamp) => {
    dataSet = [];
    $.ajax({
        url: root_1_hist + route + '/SECTORIAL VIEW',
        type: 'GET',
        dataType: 'json',
        data: {
            cast: 'hist',
...
dataTable = $('#sectorial_1_nifty50').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route + '/NIFTY 50',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
dataTable_2 = $('#sectorial_2_bnknifty').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route + '/NIFTY BANK',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
dataTable_3 = $('#sectorial_3_niftyauto').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route + '/NIFTY AUTO',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
dataTable_4 = $('#sectorial_4_niftyfinserv').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route + '/NIFTY FIN SERV',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
dataTable_5 = $('#sectorial_5_niftyfmcg').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route + '/NIFTY FMCG',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
dataTable_6 = $('#sectorial_6_niftyit').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route + '/NIFTY IT',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
dataTable_7 = $('#sectorial_7_niftymedia').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route + '/NIFTY MEDIA',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
dataTable_8 = $('#sectorial_8_niftymetal').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route + '/NIFTY METAL',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
dataTable_9 = $('#sectorial_9_niftypharma').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route + '/NIFTY PHARMA',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
dataTable_10 = $('#sectorial_10_niftypsubank').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route + '/NIFTY PSU BANK',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
dataTable_11 = $('#sectorial_11_pvtbank').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route + '/NIFTY PVT BANK',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
dataTable_12 = $('#sectorial_12_reality').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route + '/NIFTY REALITY',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
...
dataTable_13 = $('#sectorial_13_energy').DataTable({
    ...
    "ajax": {
        "url": root_1_hist + route + '/NIFTY ENERGY',
        "type": "GET",
        "dataType": 'json',
        "data": function (d) {
            d.cast = "hist";
